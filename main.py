...
def main():
    ...
    X, V = initial_trajectory(3, 0.6, -135, gal1.M) # We send the dwarf galaxy on a collision course along an elliptic conic
    ...
    merg.RUN(0.01, 10, method='Runge_Kutta') # We run some calculations
    merg.display(gif_fps=25, gif_duration=10) # We create a GIF from the showcased Matplotlib animation
